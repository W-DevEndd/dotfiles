...
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 4,  bezier = "outBack", style = "slide bottom" })
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 4, bezier = "outBack", style = "slide bottom" })
